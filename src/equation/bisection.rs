...
pub fn bisection<F>(function: F, left: f64, right: f64, acceptable_error: f64) -> Result<f64, BisectionError>
where
    F: Fn(f64) -> f64,
{
    if left > right {
...
fn bisection_rec<F>(function: F, left: f64, right: f64, acceptable_error: f64) -> Result<f64, BisectionError>
where
    F: Fn(f64) -> f64,
{
